inst.libs <- function(pkgs=NULL){
	 if(is.null(pkgs)){
	 	pkgs <- c("tidyverse", "ISLR", "FNN", "glmnet", "kernlab", "pROC", "openintro", "BHH2", "rmarkdown","ggplot2")#, "MASS")
	 }else{
	 	pkgs <- c(pkgs, c("tidyverse", "ISLR", "FNN", "glmnet", "kernlab", "pROC", "openintro", "BHH2", "rmarkdown","ggplot2"))#, "MASS"))
	 }
